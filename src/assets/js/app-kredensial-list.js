...
$(function () {
  ...
  var dt_kredensial_table = $('.kredensial-list-table');

  // Invoice datatable
  if (dt_kredensial_table.length) {
    var dt_invoice = dt_kredensial_table.DataTable({
      "serverSide": true,
      ajax: {url:'/api/permohonan_kredensial/?format=datatables'},
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 1,
          render: function (data, type, full, meta) {
                var $kredensial_id = full['id'];
                // Creates full output for row
                var $row_output = '<a href="/app/kredensial_lists/'+ $kredensial_id + '"><span>#' + $kredensial_id + '</span></a>';
                return $row_output;
              }
        }
        // {
        ...
        //     var $kredensial_id = full['id'];
        //     // Creates full output for row
        //     var $row_output = '<a href="/app/invoice/preview/"><span>#' + $kredensial_id + '</span></a>';
        //     return $row_output;
        //   }
      ...
      //         '<a href="/app/invoice/preview/" data-bs-toggle="tooltip" class="text-body" data-bs-placement="top" title="Preview Invoice"><i class="mdi mdi-eye-outline mdi-20px mx-1"></i></a>' +
      //         '<div class="dropdown">' +
      ...
      buttons: [
        {
          text: '<i class="mdi mdi-plus me-md-1"></i><span class="d-md-inline-block d-none">Daftar Baru</span>',
          className: 'btn btn-primary waves-effect waves-light',
          action: function (e, dt, button, config) {
            window.location = '/app/permohonankredensial/add/';
          }
        }
      ],
  ...
  // dt_kredensial_table.on('draw.dt', function () {
